...
Initially, you be shown the actual number
belonging to each unit. During the hacking phase every unit will be
referenced with this number in the task description, meaning
you must memorize them.

![numbers](docs/numbers.png "Unit numbers")

In the hacking phase you will be given 2 random properties of the four units.
...
![solutions](docs/solutions.png "Solutions")
